...
# CONFIG_FILENAME = "experiment_sota/parse2022_LC_32_50_mbd.yaml"
# CONFIG_FILENAME = "experiment_sota/parse2022_LC_64_50_recgan_3d.yaml"
...
DENSITY_LOWER_THRESHOLD = config_data.get("DENSITY_LOWER_THRESHOLD", 0.1)
DENSITY_UPPER_THRESHOLD = config_data.get("DENSITY_UPPER_THRESHOLD", 0.9)
...
if INCLUDE_2D_PROJECTIONS:
    DENSITY_LOWER_THRESHOLD *= (DATA_CROP_SIZE ** 2)
    DENSITY_UPPER_THRESHOLD *= (DATA_CROP_SIZE ** 2)
# 3D density thresholds
else:
    DENSITY_LOWER_THRESHOLD *= (DATA_CROP_SIZE ** 3)
    DENSITY_UPPER_THRESHOLD *= (DATA_CROP_SIZE ** 3)
